...
module.exports = Alert = class {
    ...
    #buildInfoIcon() {
        switch (typeof this.info) {
            ...
            case 'object':
                if (this.info.hasOwnProperty('icon')) {
                    return this.#toHTML(`<span class="alert__info">${this.info.icon}</span>`)
                }
        }
    }
    ...
    #buildCloseIcon() {
        switch (typeof this.close) {
            ...
            case 'object':
                if (this.close.hasOwnProperty('icon')) {
                    this.button = this.#toHTML(`('<button class="alert__close" role="button">${this.close.icon}</button>`)
